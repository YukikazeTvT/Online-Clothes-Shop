...
public class EditCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (category.getImage() != null && !category.getImage().isEmpty()) {
            imageUri = Uri.fromFile(new File(category.getImage()));
            updateImageDisplay();
        }
        ...
        btnSaveCategory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (categoryName.isEmpty()) {
                    Toast.makeText(EditCategoryActivity.this, "Please enter category name", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (imageUri == null) {
                    Toast.makeText(EditCategoryActivity.this, "Please upload an image", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (imagePath == null) {
                    Toast.makeText(EditCategoryActivity.this, "Failed to save image", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                // Save to database
                CategoryDAO categoryDAO = new CategoryDAO(EditCategoryActivity.this);
